...
sudo apt install libnanomsg-dev liblua5.3-dev libudev-dev libevdev-dev liblo-dev libcairo2-dev liblua5.3-dev libavahi-compat-libdnssd-dev libasound2-dev libsndfile1-dev -y
...
sudo cp -f /home/we/skuld/install/norns/files/interfaces /etc/network
sudo cp -f /home/we/skuld/install/norns/files/systemd-udevd.service /lib/systemd/system/
